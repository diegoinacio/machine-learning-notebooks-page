export const HEADER = {
  ...
  description: `An authorial collection of <span class="machine-learning">Machine Learning</span> fundamentals and useful <span class="notebooks">python notebooks</span>.`,
};
